    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-40">
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-700">
                  {selectedYear?.name || t('common.selectYear')}
                </span>
              ...
              {isYearDropdownOpen && (
                <div className="absolute top-full mt-1 right-0 w-64 bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-50">
                  <div className="px-3 py-2 border-b border-gray-100">
                    <p className="text-xs font-medium text-gray-500 uppercase">{t('common.schoolYears')}</p>
                  </div>
          ...
          {/* Right Section - User, Language & Sign Out */}
          <div className="flex items-center gap-4">
            {userEmail && (
